...
import { ArrowLeft, Building2, DollarSign, Users, TrendingUp } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">
            Channel <span className="text-[#0EA5E9]">Partner Portal</span>
          </h1>
          <p className="text-[#94A3B8] mt-2">
            Welcome back, {user?.firstName}! Manage your channel partnerships and earnings.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-[#1A1F3A] border border-[#2D3B5F] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[#94A3B8] text-sm">Active Locations</span>
            </div>
          ...
          <div className="bg-[#1A1F3A] border border-[#2D3B5F] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[#94A3B8] text-sm">Total Clients</span>
            </div>
        ...
        {/* Main Content */}
        <div className="bg-[#1A1F3A] border border-[#2D3B5F] rounded-xl p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Your Clients</h2>
          
          <div className="text-center py-12 text-[#64748B]">
            <Building2 className="w-12 h-12 mx-auto mb-3 opacity-50" />
            <p>No clients yet</p>
            <p className="text-sm mt-1">Start onboarding location partners to grow your network!</p>
          </div>
        </div>
      </div>
    </div>
