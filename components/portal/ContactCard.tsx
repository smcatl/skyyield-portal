...
import { Calendar, MessageSquare, Send, Phone, Mail, ExternalLink } from 'lucide-react'
...
export default function ContactCard({
  ...
  const submitTicket = async () => {
    ...
    setSubmitting(true)
    try {
      // TODO: Connect to actual ticket API
      ...
      <div className="space-y-3">
          ...
          <div className="bg-[#0A0F2C] rounded-lg p-4 space-y-3 border border-[#2D3B5F]">
            {submitted ? (
              <div className="text-center py-4">
                ...
                <div className="text-[#64748B] text-sm mt-1">We'll get back to you soon.</div>
              </div>
            ) : (
              <>
                <input
        ...
        <div className="flex gap-3 pt-2">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 p-2 bg-[#0A0F2C] rounded-lg text-[#94A3B8] hover:text-white hover:bg-[#2D3B5F] transition-colors text-sm"
          >
